...
ActiveRecord::Schema.define(version: 20161128045638) do
  ...
  add_index "admins_permissions", ["admin_id"], name: "index_admins_permissions_on_admin_id", using: :btree
  add_index "admins_permissions", ["permission_id"], name: "index_admins_permissions_on_permission_id", using: :btree
